...
from mpmath.libmp import (fhalf, from_float, from_rational, from_str,
                          ...
                          round_up, round_down,
                          to_rational, to_str, tie_to_even)
...
def test_basic_string():
    ...
    assert to_str(from_str('0.25', 80), 1) == "0.3"
    assert to_str(from_str('0.25', 80), 1, tying=tie_to_even) == "0.2"
    ...
    with pytest.raises(NotImplementedError):
        ...
        to_str(mpf('1.234'), 4, base=7, tying=tie_to_even)
